...
//            }
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        VideoAdapter.VideoPlayerViewHolder holder = (VideoAdapter.VideoPlayerViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
        thumbnail = holder.getThumnbail();
        ...
        if (mediaUrl != null) {
            MediaSource videoSource = new ProgressiveMediaSource.Factory(dataSourceFactory).createMediaSource(MediaItem.fromUri(mediaUrl));
    ...
    private void animateVolumeControl(){
        if(volumeControl != null){
            ...
            if(volumeState == VolumeState.OFF){
                ...
                Glide.with(context).load(R.drawable.ic_volume_up)
                        .into(volumeControl);
            }
